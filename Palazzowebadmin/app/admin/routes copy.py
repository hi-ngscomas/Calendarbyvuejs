...
@blueprint.route('/changedown/<int:id>',methods=['GET','POST'])
@login_required
def changepromopridown():
    try:
        id = request.data['id']
...
@blueprint.route('/changeup/<int:id>',methods=['GET','POST'])
@login_required
...
def edit_promotion(id):
    ...
    if form.is_submitted():
        ...
        events.name             = form.eventname.data
